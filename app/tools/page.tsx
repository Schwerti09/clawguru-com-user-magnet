...
function analyze(text: string): Finding[] {
  ...
  if (/api[_-]?key\s*:\s*['\"][^'\"]+['\"]/i.test(t)) {
    add("high", "Secrets im Klartext", "API Keys nicht in Config committen. Nutze Vault/ENV/Secret Manager.")
  }
    ...
    <Container>
      <div className="py-16 max-w-6xl mx-auto">
        ...
        <p className="text-gray-300 text-lg mb-10">
          Schnelle, praktische Utilities. Kein Login. Kein Bullshit.
        </p>

        <div className="grid lg:grid-cols-2 gap-8">
          <div className="p-7 rounded-2xl border border-gray-800 bg-black/30">
            <h2 className="text-2xl font-black mb-2">OpenClaw Config Validator</h2>
            <p className="text-gray-400 mb-4">
              Paste Config (oder relevante Snippets). Wir suchen typische Misconfigs.
            </p>
            <textarea
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              <button
                ...
                className="px-5 py-3 rounded-xl bg-brand-cyan/15 border border-brand-cyan/30 hover:bg-brand-cyan/25 font-bold disabled:opacity-50"
              >
                Report downloaden
              </button>
              <a
                href="/security/notfall-leitfaden"
                className="px-5 py-3 rounded-xl bg-brand-red/10 border border-brand-red/30 hover:bg-brand-red/15 font-bold"
              >
                Notfall-Leitfaden
              </a>
            </div>
            ...
            <div className="mt-4 text-xs text-gray-500">
              Hinweis: Pattern-basiert. Für Enterprise-Audits: SAST/DAST + Infrastruktur-Checks.
            </div>
          </div>

          <div className="p-7 rounded-2xl border border-gray-800 bg-gradient-to-br from-gray-900/60 to-black">
            <h2 className="text-2xl font-black mb-4">Ergebnis</h2>
            <div className="space-y-3">
              {config.trim() ? (
                ...
                <div className="p-6 rounded-2xl border border-gray-800 bg-black/30 text-gray-400">
                  Paste etwas links rein, dann bekommst du Findings hier.
                </div>
              )}
            </div>

            <div className="mt-8 p-5 rounded-2xl border border-gray-800 bg-black/30">
              <div className="font-black mb-2">Nächster Move</div>
              <p className="text-gray-300 text-sm">
                Wenn du mit Findings rausgehst: zuerst Keys rotieren, dann Exposition schließen, dann Hardening.
              </p>
              <div className="mt-4 flex flex-wrap gap-2">
                <a className="px-4 py-2 rounded-xl bg-black/30 border border-gray-700 hover:bg-black/40" href="/einrichtung">
                  Setup-Guide
                </a>
                <a className="px-4 py-2 rounded-xl bg-black/30 border border-gray-700 hover:bg-black/40" href="/hosting-kosten">
                  Kosten/Hosting
                </a>
                <a className="px-4 py-2 rounded-xl bg-black/30 border border-gray-700 hover:bg-black/40" href="/openclaw-security-2026">
                  Lagebericht
                </a>
              </div>
            </div>

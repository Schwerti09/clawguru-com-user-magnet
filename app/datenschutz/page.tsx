    ...
    <Container>
      <div className="py-16 max-w-4xl mx-auto">
        ...
        <p className="text-gray-300">
          Kurzfassung: Wir speichern keine Eingaben aus dem Security-Check dauerhaft. Server-Logs können technisch notwendige Metadaten enthalten.
        ...
        <div className="mt-8 p-6 rounded-2xl border border-gray-800 bg-black/30 text-gray-300">
          ...
          <p>Aktuell setzen wir keine Tracking-Cookies voraus. Wenn du später Analytics nutzt, ergänze diese Seite entsprechend.</p>
        </div>
      </div>
    </Container>
  )

...
export default function TrustBadge() {
  return (
    <div className="sticky top-0 z-50 border-b border-gray-800 bg-black/40 backdrop-blur">
      <div className="max-w-6xl mx-auto px-4 py-2 flex flex-wrap items-center gap-3 text-xs text-gray-300">
        <span className="inline-flex items-center gap-2">
          ...
          <strong className="text-gray-100">LIVE</strong> Lagezentrum
        </span>
        <span className="text-gray-500">•</span>
        <span>
          {formatNumber(SECURITY_STATS.exposedInstances)} exponierte Instanzen
        </span>
        <span className="text-gray-500">•</span>
